...
var app = {
    preload: function () {
        ...
        function goCreatingProcess () {
            ...
            $('.scene06').css({'backgroundImage': 'url(' + app.imgPath[3] + ')'});
    ...
    create: function (){
        app.mySwiper = new Swiper ('.swiper-container', {
            ...
            onInit: function () {
                ...
                $('.scene04').css({'backgroundImage': 'url(assets/images/bg04.jpg)'});
            ...
            onTransitionEnd: function (swiper) {
                ...
                if (swiper.activeIndex == $('.scene').length-1) {
                    $('.arrow').hide();
                    app.btnTimer = setTimeout(function () {
                        $('.scene08 .btn').addClass('animate');
                    }, 3000);
                } else {
                    clearTimeout(app.btnTimer);
        ...
        // share
        var shareTimer = null;
        $('.scene08 .btn').on('touchstart', function (e) {
            e.stopPropagation();
        ...
        $('.scene08').on('touchstart', function () {
            $('.share').fadeOut();
        });
    },
